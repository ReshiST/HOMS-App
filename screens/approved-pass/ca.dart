...
import '../../main.dart';
class CAApprovedPassScreen extends StatefulWidget {
  @override
  _CAApprovedPassScreenState createState() => _CAApprovedPassScreenState();
}

class _CAApprovedPassScreenState extends State<CAApprovedPassScreen> {
  ...
  final response = await http.post(
    Uri.parse('https://reshist.me/homspwa/api/ca-approved-pass.php'),
    body: {
              ...
              child: ListTile(
                ...
                subtitle: Column(
                  ...
                  children: [
                    ...
                    // Current Status
                    Text('Current Status: ${caStatusDetails['text']}',
