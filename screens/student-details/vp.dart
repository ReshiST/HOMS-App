...
class VPStudentDetail extends StatefulWidget {
  @override
  _VPStudentDetailState createState() => _VPStudentDetailState();
}

class _VPStudentDetailState extends State<VPStudentDetail> {
  List<Map<String, String>> studentList = [];

  Future<List<Map<String, String>>> fetchStudentData() async {
    final response = await http.get(Uri.parse('https://reshist.me/homspwa/api/vp-students.php'));
