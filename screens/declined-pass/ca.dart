...
import '../../main.dart';
class CADeclinedPassScreen extends StatefulWidget {
  @override
  _CADeclinedPassScreenState createState() => _CADeclinedPassScreenState();
}

class _CADeclinedPassScreenState extends State<CADeclinedPassScreen> {
  ...
  final response = await http.post(
    Uri.parse('https://reshist.me/homspwa/api/ca-declined-pass.php'),
    body: {
              ...
              child: ListTile(
                ...
                subtitle: Column(
                  ...
                  children: [
                    ...
                    // HOD Status
                    Text('CA Status: ${hodStatusDetails['text']}',
