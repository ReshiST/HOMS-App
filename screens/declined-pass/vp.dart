...
import '../../main.dart';
class VPDeclinedPass extends StatefulWidget {
  @override
  _VPDeclinedPassState createState() => _VPDeclinedPassState();
}

class _VPDeclinedPassState extends State<VPDeclinedPass> {
    List<Map<String, String>> passHistory = [];

  // Fetch pass data from API
  Future<List<Map<String, String>>> fetchPassData() async {
    final response = await http.get(Uri.parse('https://reshist.me/homspwa/api/vp-declined-pass.php'));
                ...
                subtitle: Column(
                  ...
                  children: [
                    ...
                    Text('To: ${pass['toDate']} ${pass['inTime']}', style: GoogleFonts.poppins(fontSize: 14)),
                     Text('Warden: ${currentStatusDetails['text']}',
