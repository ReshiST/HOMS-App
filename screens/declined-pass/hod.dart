...
import '../../main.dart';
class HODDeclinedPassScreen extends StatefulWidget {
  @override
  _HODDeclinedPassScreenState createState() => _HODDeclinedPassScreenState();
}

class _HODDeclinedPassScreenState extends State<HODDeclinedPassScreen> {
  ...
  Future<void> fetchPassData() async {
    ...
    try {
      final response = await http.post(
        Uri.parse('https://reshist.me/homspwa/api/hod-declined-pass.php'),
        body: {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('HoD Declined Pass', style: GoogleFonts.poppins(fontSize: 22, fontWeight: FontWeight.bold)),
                        ...
                        child: ListTile(
                          ...
                          subtitle: Column(
                            ...
                            children: [
                              ...
                              // HOD Status
                              Text('HOD Status: ${caStatusDetails['text']}',
